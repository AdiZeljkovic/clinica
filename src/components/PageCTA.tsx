...
export default function PageCTA({ title, subtitle, buttonLabel, buttonTo }: Props) {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24"
      ...
      <div className="relative z-10 max-w-[88rem] mx-auto px-5 sm:px-14 text-center">
        ...
        <Link to={buttonTo}
          className="inline-flex items-center gap-3 h-[52px] px-9 bg-white text-[#e5252a] font-bold text-[13px] uppercase tracking-wide rounded-full hover:bg-gray-50 transition-colors duration-200 group"
